...
func (f *kafkaSourceRunEFactory) ListRunE() sourcetypes.RunE {
	return func(cmd *cobra.Command, args []string) error {
		...
		kafkaSourceListColumnDefinitions := []metav1.TableColumnDefinition{
			...
			{Name: "Age", Type: "string", Description: "Type of the source", Priority: 1},
			{Name: "BootstrapServers", Type: "string", Description: "Sink of the source", Priority: 1},
			{Name: "Topics", Type: "string", Description: "Sink of the source", Priority: 1},
			{Name: "ConsumerGroup", Type: "string", Description: "Sink of the source", Priority: 1},
		}
